...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Guardar R.") action QuickSave("Q.Save")
            textbutton _("Cargar R.") action QuickLoad("Q.Load")
...
screen main_menu():
    ...
    imagebutton auto "images/icons/patreon_%s.png":
        action OpenURL("http://patreon.com/Luchetty")
        at patreonbutton
    ...
    hbox:
        ...
        textbutton _("Comenzar") action Start() text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]

        textbutton _("Cargar") action ShowMenu("load") text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]

        textbutton _("Opciones") action ShowMenu("preferences") text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]

        textbutton _("Acerca de") action ShowMenu("about") text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):


            textbutton _("Ayuda") action ShowMenu("help") text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]

        if renpy.variant("pc"):



            textbutton _("Salir") action Quit(confirm=not main_menu) text_size 35 text_outlines [ (absolute(2), "#000000", absolute(0), absolute(0)) ]
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton "Español" text_font "DejaVuSans.ttf" action Language(None)
